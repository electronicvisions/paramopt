...
Finding suitable model parameters which allow to replicate a given observation, is an omnipresent problem.
In this repository we collect utility functions which simplify the parameter optimization with genetic algorithms and abstract Bayesian Computation methods.
More specifically, it warps or extends the functionality of the following python packages:
- [sib](https://github.com/mackelab/sbi)
...
c ./waf setup --repo-db-url=https://github.com/electronicvisions/projects --project=paramopt
...
## License
```
Parameter Optimization ('paramopt')
